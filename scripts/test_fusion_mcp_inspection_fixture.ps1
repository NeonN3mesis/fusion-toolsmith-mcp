...
'@
    ...
    $shellSeed = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 13 -Name "create_rounded_rectangle_body" -Arguments @{
    ...
    $shellResult = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 14 -Name "shell_body" -Arguments @{
    ...
    $offsetSeed = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 15 -Name "create_rounded_rectangle_body" -Arguments @{
    ...
    $offsetFaces = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 16 -Name "get_body_faces" -Arguments @{
    ...
    $offsetResult = Invoke-McpToolAllowError -Uri $mcpUri -SessionId $sessionId -Id 17 -Name "offset_face_or_press_pull" -Arguments @{
        body_name = "Fixture_OffsetBody"
    ...
    $patternSeed = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 18 -Name "create_rounded_rectangle_body" -Arguments @{
    ...
    $patternResult = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 19 -Name "pattern_feature" -Arguments @{
    ...
    $mirrorResult = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 20 -Name "mirror_features_or_bodies" -Arguments @{
    ...
    $printability = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 21 -Name "inspect_printability" -Arguments @{
        body_names = @("Fixture_BaseBody", "Fixture_OffsetBody", "Fixture_ShellBody", "Fixture_RevolveBody")
    } -TimeoutSec $TimeoutSec -ExtraHeaders $authHeaders
    ...
    $demoCapture = Invoke-McpTool -Uri $mcpUri -SessionId $sessionId -Id 22 -Name "capture_demo_sequence" -Arguments @{
