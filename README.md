...
- `modeling`: structured sketches, constraints, projection, extrude/revolve/loft/fillet/chamfer/shell, offset face, combine, primitives, construction geometry, rounded cuts/pockets, hole patterns, mirror/pattern, appearance, mesh conversion, and component organization.
...
| Safe modeling | typed sketching, extrudes, revolves, lofts, fillets, chamfers, shelling, `offset_face_or_press_pull`, holes, pockets, mirrors, patterns, construction geometry |
